...
export default function HomePage() {
  ...
  const analyseContract = useCallback(
    async (text: string) => {
      setIsLoading(true);
      setError("");
      setAnalysis(null);
        ...
        <header className="border-b border-white/[0.06] bg-surface-950/80 backdrop-blur-lg sticky top-0 z-40">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-brand-500/15" aria-hidden="true">
            ...
            <div className="mx-auto max-w-2xl animate-fade-in">
              ...
              <div className="text-center mb-10">
                ...
                <p className="text-lg text-surface-400 leading-relaxed max-w-xl mx-auto">
                  Upload a legal contract and let AI identify risky clauses,
                  assess exposure, and generate negotiation strategies — in
                  seconds.
                </p>
              </div>
              ...
              {error && (
                ...
                >
                  <div className="flex items-start gap-3">
                    <svg className="h-5 w-5 text-red-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
        ...
        <footer className="border-t border-white/[0.06] mt-16">
          <div className="mx-auto max-w-7xl px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-surface-500">
              © {new Date().getFullYear()} ClauseGuard AI — For informational purposes only
            </p>
